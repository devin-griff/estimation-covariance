...
RUN STATIC=$(python -c "import streamlit, os; print(os.path.join(os.path.dirname(streamlit.__file__), 'static'))") \
    && sed -i 's|<title>Streamlit</title>|<title>Parameter Estimation Covariance</title>|' "$STATIC/index.html" \
    && sed -i 's|</head>|<link rel="icon" type="image/png" href="./favicon.png"/><meta property="og:type" content="website"/><meta property="og:title" content="Parameter Estimation Covariance"/><meta property="og:description" content="Parameter uncertainty from one solve, checked against Monte Carlo"/><meta property="og:image" content="https://griffith-pse.com/images/estimation-covariance.png"/><meta property="og:site_name" content="Griffith PSE"/><meta name="twitter:card" content="summary_large_image"/><meta name="twitter:title" content="Parameter Estimation Covariance"/><meta name="twitter:description" content="Parameter uncertainty from one solve, checked against Monte Carlo"/><meta name="twitter:image" content="https://griffith-pse.com/images/estimation-covariance.png"/></head>|' "$STATIC/index.html" \
